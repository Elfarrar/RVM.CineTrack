...
using RVM.CineTrack.API.Auth;
using RVM.CineTrack.API.Health;
using RVM.CineTrack.API.Middleware;
using RVM.CineTrack.API.Services;
using RVM.CineTrack.API.Workers;
using RVM.CineTrack.Infrastructure;
...
try
{
    ...
    builder.Services.AddHostedService<ReleaseAlertWorker>();
    ...
    app.MapControllers();
    app.MapRazorComponents<RVM.CineTrack.API.Components.App>()
